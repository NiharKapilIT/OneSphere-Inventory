...
import { salesQuotationConfig } from '../../Inventory_Shared/inventory-screen.model';
...
@Component({
  selector: 'app-inventory-sales-quotation',
  standalone: true,
...
export class InventorySalesQuotationComponent extends InventoryScreenShell {
  override readonly config = salesQuotationConfig;
}
