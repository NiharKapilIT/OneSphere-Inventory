...
import { purchaseOrderConfig } from '../../Inventory_Shared/inventory-screen.model';
...
export class InventoryPurchaseOrderComponent extends InventoryScreenShell {
  override readonly config = purchaseOrderConfig;
}
