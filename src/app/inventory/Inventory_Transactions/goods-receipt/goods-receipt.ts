...
@Component({
  ...
  styles: [`
    /* Product Picker rollout: the shared .grn-grid-compact base (styles.scss)
       ...
       (see goods-receipt.html -- the picker is the only control in this
    ...
    :host ::ng-deep .goods-receipt-line-grid .erp-table.compact th.inventory-line-col-product,
    :host ::ng-deep .goods-receipt-line-grid .erp-table.compact td.inventory-line-col-product {
      min-width: 190px;
      width: 190px;
    }
  `]
