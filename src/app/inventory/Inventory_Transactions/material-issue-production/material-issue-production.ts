...
import { materialIssueProductionConfig } from '../../Inventory_Shared/inventory-screen.model';
...
@Component({
  selector: 'app-inventory-material-issue-production',
  standalone: true,
  ...
  templateUrl: './material-issue-production.html'
})
export class InventoryMaterialIssueProductionComponent extends InventoryScreenShell {
  override readonly config = materialIssueProductionConfig;
}
