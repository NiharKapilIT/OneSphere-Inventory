...
import { salesReturnConfig } from '../../Inventory_Shared/inventory-screen.model';
...
@Component({
  selector: 'app-inventory-sales-return',
  standalone: true,
  ...
  styles: [`
    /* Product Picker rollout: the shared .grn-grid-compact base (styles.scss)
       ...
       (see sales-return.html -- the picker is the only control in this
    ...
    :host ::ng-deep .sales-return-line-grid .erp-table.compact th.inventory-line-col-product,
    :host ::ng-deep .sales-return-line-grid .erp-table.compact td.inventory-line-col-product {
      min-width: 190px;
      width: 190px;
    }
  `]
})
export class InventorySalesReturnComponent extends InventoryScreenShell {
  override readonly config = salesReturnConfig;
}
