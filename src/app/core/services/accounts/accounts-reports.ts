...
export class AccountsReports {
  GetScheduleTBReport(Date: string | number | boolean): Observable<any> {

  const params = new HttpParams()
    .set('fromDate', 'null')
    .set('toDate', String(Date))
...
GetLedgerExtractReport(
  ...
  return this._CommonService.getAPI(
    '/Accounts/GetLedgerExtractReport',
    params,
    'YES'
  );
}
