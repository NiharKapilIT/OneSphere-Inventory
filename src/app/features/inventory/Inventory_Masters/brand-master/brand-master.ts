...
import { brandMasterConfig } from '../../Inventory_Shared/inventory-screen.model';
...
@Component({
  selector: 'app-inventory-brand-master',
  standalone: true,
...
export class InventoryBrandMasterComponent extends InventoryScreenShell {
  override readonly config = brandMasterConfig;
}
